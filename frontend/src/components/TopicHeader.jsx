      ...
      <div className="header-content">
        <div style={{display: 'flex', alignItems: 'center', gap: '16px'}}>
          ...
          <div className="header-nav" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            {/* Topic Sheets Dropdown */}
            <div className="dropdown" style={{ position: 'relative', display: 'inline-block' }}
              onMouseLeave={() => {
                setTimeout(() => {
                  const dropdown = document.querySelector('.topic-dropdown-content');
              ...
              <button 
                ...
                onMouseEnter={(e) => {
                  ...
                  e.target.style.backgroundColor = isDark ? 'rgba(30, 144, 255, 0.3)' : 'rgba(30, 144, 255, 0.2)';
                }}
                onMouseLeave={(e) => {
              ...
              <div 
                className="topic-dropdown-content"
                style={{
                  display: 'none',
                  position: 'absolute',
              ...
              >
                {/* Arrays & Strings */}
                <button onClick={() => window.location.href = '/topic/arrays'} style={{
                ...
                {/* Linked Lists */}
                <button onClick={() => window.location.href = '/topic/linkedlist'} style={{
                ...
                >
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M3,7H21L19,4H5L3,7M5,8V19A1,1 0 0,0 6,20H18A1,1 0 0,0 19,19V8H5Z"/>
                  </svg>
                  Linked Lists (25 Problems)
                </button>

                {/* Stacks & Queues */}
                <button onClick={() => window.location.href = '/topic/stacks-queues'} style={{
                  color: isDark ? '#e5e7eb' : '#374151',
                  padding: '10px 16px',
                  textDecoration: 'none',
                  display: 'flex',
                ...
                >
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M2,5.27L3.28,4L20,20.72L18.73,22L15.73,19H7A2,2 0 0,1 5,17V7.27L2,4.27L2,5.27M19,17V7A2,2 0 0,0 17,5H8.82L6.82,3H17A4,4 0 0,1 21,7V17A4,4 0 0,1 19.18,20.18L17.18,18.18C18.2,17.91 19,16.95 19,17Z"/>
                  </svg>
                  Stacks & Queues (30 Problems)
                </button>

                {/* Trees */}
                <button onClick={() => window.location.href = '/topic/trees'} style={{
                  color: isDark ? '#e5e7eb' : '#374151',
                  padding: '10px 16px',
                  textDecoration: 'none',
                  display: 'flex',
                ...
                {/* Graphs */}
                <button onClick={() => window.location.href = '/topic/graphs'} style={{
                  color: isDark ? '#e5e7eb' : '#374151',
                  padding: '10px 16px',
                  textDecoration: 'none',
                  display: 'flex',
                ...
                {/* Dynamic Programming */}
                <button onClick={() => window.location.href = '/topic/dp'} style={{
                  color: isDark ? '#e5e7eb' : '#374151',
                  padding: '10px 16px',
                  textDecoration: 'none',
                  display: 'flex',
                ...
                <button onClick={() => window.location.href = '/topic/recursion'} style={{
                  color: isDark ? '#e5e7eb' : '#374151',
                  padding: '10px 16px',
                  textDecoration: 'none',
                  display: 'flex',
            ...
            <div className="dropdown" style={{ position: 'relative', display: 'inline-block' }}
              onMouseLeave={() => {
                setTimeout(() => {
                  const dropdown = document.querySelector('.dsa-dropdown-content');
                  if (dropdown && !dropdown.matches(':hover')) {
                    dropdown.style.display = 'none';
                  }
                }, 300);
              ...
              <div 
                className="dsa-dropdown-content"
                style={{
                  display: 'none',
                  position: 'absolute',
                  backgroundColor: isDark ? '#1f2937' : 'white',
