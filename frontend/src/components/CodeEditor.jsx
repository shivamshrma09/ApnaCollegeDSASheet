...
class Program {
  ...
  const simulateExecution = (codeToRun) => {
    // Advanced code simulation for all languages
  ...
  const simulateCpp = (code) => {
    ...
    // Handle cin operations and simulate calculator
  ...
  const handleEditorDidMount = (editor, monaco) => {
    ...
    // Configure editor options with proper syntax highlighting
  ...
  return (
    <div style={{
      ...
      {/* Enhanced VS Code-style Top Bar */}
      <div style={{
        height: '48px',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <select
            ...
            style={{
              ...
              fontWeight: '500',
              cursor: 'pointer',
              boxShadow: isDark ? '0 2px 4px rgba(0,0,0,0.2)' : '0 1px 2px rgba(0,0,0,0.05)',
              minWidth: '120px'
            }}
          >
            {languages.map(lang => (
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', gap: '24px' }}>
              <button
                ...
                style={{
                  background: consoleTab === 'testcase' ? '#1E90FF' : 'none',
                  border: 'none',
                  padding: '6px 12px',
                  borderRadius: '4px',
                  fontSize: '12px',
                  fontWeight: '600',
                  color: consoleTab === 'testcase' ? '#ffffff' : (isDark ? '#cccccc' : '#6c757d'),
                  cursor: 'pointer',
                  transition: 'all 0.2s ease',
                  display: 'flex',
                  alignItems: 'center',
                ...
                onMouseEnter={(e) => {
                  if (consoleTab !== 'testcase') {
                    e.target.style.background = isDark ? '#3c3c3c' : '#e8e8e8';
                  }
                }}
                onMouseLeave={(e) => {
                  if (consoleTab !== 'testcase') {
              ...
              <button
                ...
                style={{
                  background: consoleTab === 'result' ? '#1E90FF' : 'none',
                  border: 'none',
                  padding: '6px 12px',
                  borderRadius: '4px',
                  fontSize: '12px',
                  fontWeight: '600',
                  color: consoleTab === 'result' ? '#ffffff' : (isDark ? '#cccccc' : '#6c757d'),
                  cursor: 'pointer',
                  transition: 'all 0.2s ease',
                  display: 'flex',
                  alignItems: 'center',
          ...
          <div style={{ flex: 1, display: 'flex' }}>
            {consoleTab === 'testcase' ? (
              <div style={{ flex: 1, display: 'flex' }}>
                ...
                <div style={{
                  flex: 1,
                  borderLeft: `1px solid ${isDark ? '#3e3e3e' : '#e4e6ea'}`,
                  display: 'flex',
                  flexDirection: 'column'
                }}>
                  <div style={{
